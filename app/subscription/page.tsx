...
const SubscriptionPage = async () => {
  try {
    ...
    const [subscriptionPlan, user, currentMonthTransactions] =
      await Promise.all([
    ...
    console.error("Erro ao renderizar pagina de assinatura:", error);
    return (
      <>
        <NavBar />
        <div className="space-y-6 p-6">
          ...
          <div className="flex flex-col items-center justify-center gap-4 py-12">
            <p className="text-center text-muted-foreground">
              Ocorreu um erro ao carregar a página de assinatura. Tente
